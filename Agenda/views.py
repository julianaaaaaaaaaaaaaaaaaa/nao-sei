...
class View:
    ...
    def cliente_listar():
        r = ClienteDAO.listar()
        r.sort(key=lambda obj: obj.get_nome())  # ordena por nome
        return r
    ...
    def servico_listar():
        r = ServicoDAO.listar()
        r.sort(key=lambda obj: obj.get_descricao())  # ordena por descrição
        return r
    ...
    def horario_inserir(data, confirmado, id_cliente, id_servico, id_profissional):
        c = Horario(0, data, confirmado, id_cliente, id_servico, id_profissional)
    ...
    def horario_atualizar(id, data, confirmado, id_cliente, id_servico, id_profissional):
        c = Horario(id, data, confirmado, id_cliente, id_servico, id_profissional)
